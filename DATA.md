...
## Query 0: Script para generar el escenario de datos solicitado
...
## Query 4: Obtener la lista de productos que tienen menos de 10 unidades en stock.
...
## Query especial: Eliminar todo el escenario de datos
